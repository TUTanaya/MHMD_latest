...
#define NVME_UPDATE_SQ_TAIL(Q)  Q.Submission_queue_tail++;\
	...
	public:
        ...
        uint32_t Get_generated_read_request_count();
        uint32_t Get_generated_write_request_count();
        uint32_t Get_required_read_dt_count();
	...
	protected:
        ...
        int request_delay_increase_status=0;

		unsigned int STAT_generated_request_count, STAT_generated_read_request_count, STAT_generated_write_request_count, STAT_generated_read_DT_count;
		unsigned int STAT_ignored_request_count;
		unsigned int STAT_serviced_request_count, STAT_serviced_read_request_count, STAT_serviced_write_request_count, STAT_serviced_DT_count;
